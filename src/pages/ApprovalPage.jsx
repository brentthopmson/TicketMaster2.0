    ...
    <React.Fragment>
      ...
      <div style={{ padding: '1.5rem', backgroundColor: '#f7fafc' }}>
        ...
        <div style={{ position: 'relative' }}>
          <div style={{
            position: 'absolute', top: 0, left: 0, width: '100%', backgroundColor: 'rgba(0, 0, 0, 0.75)', color: 'white', textAlign: 'center', padding: '1rem', borderRadius: '0.375rem 0.375rem 0 0', zIndex: 10
          }}>
            <p>
              This ticket is being transferred to <strong>{email}</strong>. The ownership transfer can take up to 15 minutes to complete unless retracted. The protected ticket information will be delivered to your email inbox shortly.
            </p>
          </div>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <h2 style={{ fontSize: '2rem', fontWeight: 'bold', color: '#2d3748' }}>{ticketDetails.eventName}</h2>
